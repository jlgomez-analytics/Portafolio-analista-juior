...
En este proyecto se trabajará en poder entender el comportamiento de los datos, identificar tendencias, outliers y construir visualizaciones que permitan apoyar la toma de desiciones.
